...
import com.gomaa.presentation.mapper.ArticlesUIMapper
...
class ArticlesUIMapperTest {
    ...
    fun `mapDataArticlesToUiArticles maps data articles to UI articles`() {
        ...
        // When
        val uiArticles = com.gomaa.presentation.mapper.ArticlesUIMapper.mapDataArticlesToUiArticles(articles)
    ...
    fun `calculateDaysBetween returns correct string for positive days difference`() {
        ...
        // When
        val result = com.gomaa.presentation.mapper.ArticlesUIMapper.calculateDaysBetween(publishedDate, clock)
    ...
    fun `calculateDaysBetween returns correct string for today`() {
        ...
        // When
        val result = com.gomaa.presentation.mapper.ArticlesUIMapper.calculateDaysBetween(publishedDate)
